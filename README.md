...
- timeline search and filtering by text, character, location, linked reveal text, and status, with filter state preserved while navigating, reveal-link hints on cards, and active-scene highlighting after view jumps
