...
- first-pass reveal-ledger support in the workspace, with project-level reveal records, scene and character linking, local persistence, import/export round-tripping, reveal-aware workspace search, and scene-list linkage hints
